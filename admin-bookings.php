...
$bookings = db_select('bookings', ' 1  ORDER BY id DESC');
/* 
Array
(
    [0] => Array
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <a href="admin-bookings-create.php" class="btn btn-primary">Create Booking</a>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="admin-bookings-create.php?id=<?= $booking['id'] ?>" class="btn btn-sm btn-primary">Update Booking</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
