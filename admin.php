...
<head>
    ...
    <!-- 
    <link rel="icon" type="image/x-icon" href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/assets/img/favicon/favicon.ico" />
...
<body>
    ...
    <noscript><iframe src="external.html?link=https://www.googletagmanager.com/ns.html?id=GTM-5DDHKGP" height="0" width="0" style="display: none; visibility: hidden"></iframe></noscript>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/html/horizontal-menu-template" class="menu-link" target="_blank">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/html/front-pages/landing-page.html" class="menu-link" target="_blank">
                                    <div data-i18n="Landing">Landing</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/html/front-pages/pricing-page.html" class="menu-link" target="_blank">
                                    <div data-i18n="Pricing">Pricing</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/html/front-pages/payment-page.html" class="menu-link" target="_blank">
                                    <div data-i18n="Payment">Payment</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/html/front-pages/checkout-page.html" class="menu-link" target="_blank">
                                    <div data-i18n="Checkout">Checkout</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/html/front-pages/help-center-landing.html" class="menu-link" target="_blank">
                    ...
                    <li class="menu-item">
                        <a href="external.html?link=https://pixinvent.ticksy.com/" target="_blank" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-support"></i>
                            <div data-i18n="Support">Support</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/documentation/" target="_blank" class="menu-link">
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                ...
                                </script>, made with ❤️ by <a href="external.html?link=https://pixinvent.com/" target="_blank" class="footer-link fw-medium">Pixinvent</a>
                            </div>
                            <div class="d-none d-lg-inline-block">

                                <a href="external.html?link=https://themeforest.net/licenses/standard" class="footer-link me-4" target="_blank">License</a>
                                <a href="external.html?link=https://1.envato.market/pixinvent_portfolio" target="_blank" class="footer-link me-4">More Themes</a>

                                <a href="external.html?link=https://demos.pixinvent.com/frest-html-admin-template/documentation/" target="_blank" class="footer-link me-4">Documentation</a>


                                <a href="external.html?link=https://pixinvent.ticksy.com/" target="_blank" class="footer-link d-none d-sm-inline-block">Support</a>
    ...
    <div class="buy-now">
        <a href="external.html?link=https://1.envato.market/frest_admin" target="_blank" class="btn btn-danger btn-buy-now">Buy Now</a>
    </div>
...
<!-- Mirrored from demos.pixinvent.com/frest-html-admin-template/html/vertical-menu-template/index.html by HTTrack Website Copier/3.x [XR&CO'2017], Tue, 04 Jun 2024 16:46:17 GMT -->
